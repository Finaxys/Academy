...
public class main2 {
  ...
  static  AbstractApplicationContext context = new AnnotationConfigApplicationContext(SpringContext.class);
   ...
   public static void main(String[] args) {
        ...
        ChannelTributeCreatedListener channelTributeCreatedListener =(ChannelTributeCreatedListener)context.getBean("channelTributeCreatedListener");
     ...
     SlackRealTimeMessagingClient slackRealTimeMessagingClient = SlackClientFactory.createSlackRealTimeMessagingClient(ACCESS_TOKEN);
        ...
        slackRealTimeMessagingClient.addListener(Event.CHANNEL_CREATED,channelTributeCreatedListener );
